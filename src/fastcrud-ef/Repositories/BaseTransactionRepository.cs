...
public abstract class BaseTransactionRepository<TTransaction, TEntity> : CRRepository<TEntity, Guid>, ITransactionRepository<TTransaction> where TTransaction : Transaction where TEntity : Entities.Transaction, IEntity<Guid>, IHasSerial, IHasCreatedAt
{
    protected BaseTransactionRepository(BaseDbContext context) : base(context)
    {
    }
